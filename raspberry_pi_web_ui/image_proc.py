...
def create_input_image_array():
    ...
    print(len(padded_image_grayscale_array))
    print(len(padded_image_grayscale_array[0]))
...
def reshape_and_show_image_from_list(image_grayscale_as_list):
    ...
    reshaped_output_image_array = output_image_array.reshape(402, 602)
...
if __name__ == "__main__":
    ...
    with open(os.path.join("/home/pi/ece524_proj/", "output_image_data_from_BRAM.txt"), "r") as file_for_input_array:
