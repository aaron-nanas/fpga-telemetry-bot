...
HD_PWD='/home/aaronnanas/vivado_projects/uart_test/uart_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bot_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_bot_controller.tcl -notrace
