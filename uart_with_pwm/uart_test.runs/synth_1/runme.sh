...
HD_PWD='/home/aaronnanas/vivado_projects/uart_test/uart_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bot_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bot_controller.tcl
