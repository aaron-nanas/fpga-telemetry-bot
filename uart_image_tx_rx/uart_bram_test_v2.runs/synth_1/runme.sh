...
HD_PWD='/home/aaronnanas/vivado_projects/ece524_final_proj/uart_bram_test_v2/uart_bram_test_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rx_tx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rx_tx.tcl
