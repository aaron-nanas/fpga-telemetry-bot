...
#
# Generated by Vivado on Mon Nov 08 23:24:07 PST 2021
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../vga_controller.gen/sources_1/ip/clk_wiz_0" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../vga_controller.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
