...
HD_PWD='D:/Labs/ECE524/fpga-telemetry-bot/spatial_filter/spatial_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_filter_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_filter_fsm.tcl -notrace
